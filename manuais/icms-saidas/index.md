...
<div class="secao" id="secao-acesso">
  ...
  <div class="secao-conteudo editable-area">
    ...
    <p>Ao entrar no ambiente Digital Dev, identifique o card correspondente e clique no botão <strong>"Acessar Ferramenta"</strong> no módulo de ICMS das Saídas.</p>
    <div class="img-container">
        <div class="img-wrapper">
...
<div class="secao" id="secao-3">
  ...
  <div class="secao-conteudo editable-area">
    ...
    <div class="img-container">
        <div class="img-wrapper">
            <img src="imagens/28-limpar-filtros.png" class="img-screenshot" alt="Limpar Filtros">
        </div>
...
<div class="secao" id="secao-4">
  ...
  <div class="secao-conteudo editable-area">
    ...
    <div class="img-container">
        <div class="img-wrapper">
            <img src="imagens/5-resultado-busca-apuracao-resumo.png" class="img-screenshot" alt="Resumo T01">
        </div>
        <p class="img-caption">Visão do Resumo Mensal da Apuração</p>
    </div>
    <p>Abaixo, são apresentadas as Matrizes de Apuração, que comparam o valor escriturado na EFD contra o que foi efetivamente recolhido, destacando possíveis diferenças (Check).</p>
    <div class="img-container">
        <div class="img-wrapper">
            <img src="imagens/6-apuracao-icms-normal-matriz.png" class="img-screenshot" alt="Matriz ICMS Normal">
        </div>
        <p class="img-caption">Matriz de apuração do ICMS Normal</p>
    </div>
    <div class="img-container">
        <div class="img-wrapper">
            <img src="imagens/7-apuracao-icms-difal-matriz.png" class="img-screenshot" alt="Matriz DIFAL">
        </div>
...
<div class="secao" id="secao-5">
  ...
  <div class="secao-conteudo editable-area">
    ...
    <div class="img-container">
        <div class="img-wrapper">
            <img src="imagens/8-cfop-itens-nota.png" class="img-screenshot" alt="Itens da Nota C170">
        </div>
        <p class="img-caption">Agrupamento de itens por CFOP com base no C170</p>
    </div>
    <div class="img-container">
        <div class="img-wrapper">
            <img src="imagens/9-cfop-resumo-analitico-c190.png" class="img-screenshot" alt="Resumo Analítico C190">
        </div>
...
<div class="secao" id="secao-6">
  ...
  <div class="secao-conteudo editable-area">
    ...
    <div class="img-container">
        <div class="img-wrapper">
            <img src="imagens/10-saidas-acucar-base-legal-resumo.png" class="img-screenshot" alt="Açúcar Base Legal">
        </div>
        <p class="img-caption">Base legal e resumo mensal de Açúcar</p>
    </div>
    <div class="img-container">
        <div class="img-wrapper">
            <img src="imagens/11-saidas-acucar-analise.png" class="img-screenshot" alt="Açúcar Análise Detalhada">
        </div>
    ...
    <div class="img-container">
        <div class="img-wrapper">
            <img src="imagens/14-saidas-etanol-interno-base-legal.png" class="img-screenshot" alt="Etanol Interno Base Legal">
        </div>
        <p class="img-caption">Etanol Interno: Regras e Legislação aplicáveis</p>
    </div>
    <div class="img-container">
        <div class="img-wrapper">
            <img src="imagens/15-saidas-etanol-interno-resumo-analise.png" class="img-screenshot" alt="Etanol Interno Análise">
        </div>
    ...
    <div class="img-container">
        <div class="img-wrapper">
            <img src="imagens/16-saidas-etanol-interestadual-base-legal-resumo.png" class="img-screenshot" alt="Etanol Interestadual Base Legal">
        </div>
        <p class="img-caption">Etanol Interestadual: Resumo e Base Legal</p>
    </div>
    <div class="img-container">
        <div class="img-wrapper">
            <img src="imagens/17-saidas-etanol-interestadual-analise.png" class="img-screenshot" alt="Etanol Interestadual Análise">
        </div>
    ...
    <div class="img-container">
        <div class="img-wrapper">
            <img src="imagens/19-saidas-residuo-prod-base-legal-analise.png" class="img-screenshot" alt="Resíduos Base Legal">
        </div>
        <p class="img-caption">Operações com Resíduos de Produção</p>
    </div>
    <div class="img-container">
        <div class="img-wrapper">
            <img src="imagens/20-saidas-sucata-base-legal-analise.png" class="img-screenshot" alt="Sucata Base Legal">
        </div>
    ...
    <div class="img-container">
        <div class="img-wrapper">
            <img src="imagens/21-saidas-biodiesel-base-legal-resumo.png" class="img-screenshot" alt="Biodiesel Base Legal">
        </div>
        <p class="img-caption">Base legal e resumo do Biodiesel</p>
    </div>
    <div class="img-container">
        <div class="img-wrapper">
            <img src="imagens/22-saidas-biodiesel-analise.png" class="img-screenshot" alt="Biodiesel Análise">
        </div>
...
<div class="secao" id="secao-7">
  ...
  <div class="secao-conteudo editable-area">
    ...
    <div class="img-container">
        <div class="img-wrapper">
            <img src="imagens/24-saidas-st-acucar-resumo.png" class="img-screenshot" alt="Açúcar ST Resumo">
        </div>
        <p class="img-caption">Açúcar ST - Resumo de totais por competência</p>
    </div>
    <div class="img-container">
        <div class="img-wrapper">
            <img src="imagens/25-saidas-st-acucar-analise.png" class="img-screenshot" alt="Açúcar ST Análise">
        </div>
        <p class="img-caption">Análise detalhada de saídas de Açúcar ST</p>
    </div>
    <div class="img-container">
        <div class="img-wrapper">
            <img src="imagens/26-saidas-st-etanol-interestadual-resumo.png" class="img-screenshot" alt="Etanol Interestadual ST Resumo">
        </div>
        <p class="img-caption">Etanol Interestadual ST - Resumo por competência</p>
    </div>
    <div class="img-container">
        <div class="img-wrapper">
            <img src="imagens/27-saidas-st-etanol-interestadual-analise.png" class="img-screenshot" alt="Etanol Interestadual ST Análise">
        </div>
...
<div class="secao" id="secao-8">
  ...
  <div class="secao-conteudo editable-area">
    ...
    <div class="img-container">
        <div class="img-wrapper">
            <img src="imagens/12-saidas-acucar-nova-correcao.png" class="img-screenshot" alt="Nova Correção Açúcar">
        </div>
        <p class="img-caption">Formulário de Nova Correção (Exemplo: Açúcar)</p>
    </div>
    <div class="img-container">
        <div class="img-wrapper">
            <img src="imagens/18-saidas-etanol-interestadual-nova-correcao.png" class="img-screenshot" alt="Nova Correção Etanol">
        </div>
        <p class="img-caption">Formulário de Nova Correção (Exemplo: Etanol Interestadual)</p>
    </div>
    <div class="img-container">
        <div class="img-wrapper">
            <img src="imagens/23-saidas-biodiesel-nova-correcao.png" class="img-screenshot" alt="Nova Correção Biodiesel">
        </div>
        <p class="img-caption">Formulário de Nova Correção (Exemplo: Biodiesel)</p>
    </div>
    <p>Após inserir o ajuste, o sistema exibe uma <em>badge</em> informando quantas correções foram aplicadas àquela família. A linha de correção será exibida na tabela com a numeração destacada ("CORREÇÃO").</p>
    <div class="img-container">
        <div class="img-wrapper">
            <img src="imagens/13-saidas-acucar-contagem-correcao.png" class="img-screenshot" alt="Contagem de Correções">
        </div>
