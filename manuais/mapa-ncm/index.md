...
<div class="secao" id="secao-1">
  ...
  <div class="secao-conteudo editable-area">
    ...
    <ul>
        ...
        <li><strong>Gestão de Regras:</strong> Criação, edição e exclusão de regras fiscais com trilha de auditoria.</li>
...
<div class="secao" id="secao-acesso">
  ...
  <div class="secao-conteudo editable-area">
    ...
    <p>Ao entrar no ambiente Digital Dev, o sistema carregará o <strong>Hub de Ferramentas</strong>. Utilize a seção "Sessões em Andamento" para retomar trabalhos recentes ou localize o card correspondente e clique no botão <strong>"Acessar Ferramenta"</strong>.</p>
    <div class="img-container">
        <div class="img-wrapper">
...
<div class="secao" id="secao-5">
  ...
  <div class="secao-conteudo editable-area">
    ...
    <div class="img-container">
        <div class="img-wrapper">
            <img src="imagens/9-excluir-regra.png" class="img-screenshot" alt="Excluir regra">
        </div>
...
<div class="secao" id="secao-6">
  ...
  <div class="secao-conteudo editable-area">
    <h3 id="secao-6-1">6.1. Visualização detalhada (Cards)</h3>
    <p>Ao clicar em uma regra ou buscar por um NCM específico no sistema, um painel (modal/sheet) se abre exibindo as regras atreladas àquele código. É possível visualizar dados adicionais como o <strong>período de vigência</strong>, observações internas e os dados de auditoria (quem criou/editou e quando).</p>
    <div class="img-container">
        <div class="img-wrapper">
    ...
    <p>Para adicionar um novo tratamento tributário, clique no botão verde <strong>+ Nova Regra</strong> no painel de filtros. Um formulário lateral (Sheet) se abrirá.</p>
    ...
    <div class="img-container">
        <div class="img-wrapper">
            <img src="imagens/5-nova-regra-ncm.png" class="img-screenshot" alt="Formulário de nova regra">
        </div>
    ...
    <div class="img-container">
        <div class="img-wrapper">
            <img src="imagens/7-editar-regra.png" class="img-screenshot" alt="Editar Regra">
        </div>
        <p class="img-caption">Editando as propriedades tributárias de uma regra já existente</p>
    </div>
    <p>Altere as informações necessárias e clique em "Salvar". O sistema registrará automaticamente a trilha de auditoria dessa alteração. Para sair do painel lateral e voltar à tabela principal, clique fora da janela ou utilize a tecla ESC.</p>
    <div class="img-container">
        <div class="img-wrapper">
            <img src="imagens/8-voltar-pagina-inicial.png" class="img-screenshot" alt="Voltar à página inicial">
        </div>
...
<div class="secao" id="secao-7">
  <div class="secao-header">
    ...
    <h2 class="editable-text">Boas Práticas e Auditoria</h2>
  </div>
  <div class="secao-conteudo editable-area">
    <div class="dica">
    ...
    <div class="aviso">
        ...
        <p><strong>Auditoria Automática:</strong> Todas as ações de criação, edição e exclusão no Mapa NCM são gravadas permanentemente nos logs de auditoria do sistema, contendo o autor da modificação e o diff (o que foi alterado) de cada campo.</p>
    </div>
    <div class="dica">
        <span class="material-icons-round">info</span>
