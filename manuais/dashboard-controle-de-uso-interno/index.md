...
toc:
  ...
  - id: secao-2
    title: "1. Visão geral de arquivos"
    items:
      - id: secao-2-1
        title: "1.1. Visão geral da página"
      - id: secao-2-2
        title: "1.2. Filtros disponíveis"
      - id: secao-2-3
        title: "1.3. Indicadores"
      - id: secao-2-4
        title: "1.4. Percentual de entradas e saídas adicionadas (NFe e CTe)"
      - id: secao-2-5
        title: "1.5. Total adicionado ao Drive por tipo de arquivo"
      - id: secao-2-6
        title: "1.6. Tabela geral controle de uso"
  - id: secao-3
    title: "2. Controle de uso"
    items:
      - id: secao-3-1
      ...
      - id: secao-3-4
        title: "2.4. Usuários com mais acessos"
      - id: secao-3-5
        title: "2.5. Consultas por tipo de documento"
      - id: secao-3-6
        title: "2.6. Clientes mais acessados por tipo de acesso"
  - id: secao-4
    title: "3. Detalhamento de operações"
    items:
      - id: secao-4-1
      ...
      - id: secao-4-4
        title: "3.4. Tabela de operações por usuário"
  - id: secao-5
    title: "4. Controle de uso interno"
    items:
      - id: secao-5-1
      ...
      - id: secao-5-4
        title: "4.4. Método utilizado"
      - id: secao-5-5
        title: "4.5. Taxa de sucesso e falhas"
      - id: secao-5-6
        title: "4.6. Tipos de consulta"
      - id: secao-5-7
        title: "4.7. Consultas por usuário"
---
...
<div class="secao" id="secao-1">
  ...
  <div class="secao-conteudo editable-area">
    <p>O dashboard de controle de uso tem como objetivo apresentar o volume de consultas realizadas na plataforma e o fluxo de upload de arquivos para o Drive da PSA. O documento é dividido em abas que detalham o comportamento da equipe e o status técnico das requisições via sistema e API.</p>
  </div>
</div>
...
<div class="secao" id="secao-2">
  <div class="secao-header">
    ...
    <h2 class="editable-text">Visão geral de arquivos</h2>
  </div>
  <div class="secao-conteudo editable-area">
    ...
    <h3 id="secao-2-1">1.1. Visão geral da página</h3>
    ...
    <h3 id="secao-2-2">1.2. Filtros disponíveis</h3>
    ...
    <h3 id="secao-2-3">1.3. Indicadores</h3>
    ...
    <h3 id="secao-2-4">1.4. Percentual de entradas e saídas adicionadas (NFe e CTe)</h3>
    ...
    <h3 id="secao-2-5">1.5. Total adicionado ao Drive por tipo de arquivo</h3>
    ...
    <h3 id="secao-2-6">1.6. Tabela geral controle de uso</h3>
...
<div class="secao" id="secao-3">
  ...
  <div class="secao-conteudo editable-area">
    ...
    <h3 id="secao-3-1">2.1. Visão geral da página</h3>
    ...
    <h3 id="secao-3-2">2.2. Filtros disponíveis</h3>
    <p>Compartilha os mesmos filtros (Período, Clientes, Empresas e Usuários) descritos na visão geral de arquivos.</p>
    <div class="img-container">
    ...
    <h3 id="secao-3-3">2.3. Indicadores</h3>
    ...
    <h3 id="secao-3-4">2.4. Usuários com mais acessos</h3>
    ...
    <h3 id="secao-3-5">2.5. Consultas por tipo de documento</h3>
    ...
    <h3 id="secao-3-6">2.6. Clientes mais acessados por tipo de acesso</h3>
...
<div class="secao" id="secao-4">
  ...
  <div class="secao-conteudo editable-area">
    ...
    <h3 id="secao-4-1">3.1. Visão geral da página</h3>
    ...
    <h3 id="secao-4-2">3.2. Filtros disponíveis</h3>
    ...
    <h3 id="secao-4-3">3.3. Indicadores</h3>
    ...
    <h3 id="secao-4-4">3.4. Tabela de operações por usuário</h3>
...
<div class="secao" id="secao-5">
  ...
  <div class="secao-conteudo editable-area">
    ...
    <h3 id="secao-5-1">4.1. Visão geral da página</h3>
    ...
    <h3 id="secao-5-2">4.2. Filtros disponíveis</h3>
    ...
    <h3 id="secao-5-3">4.3. Indicadores</h3>
    ...
    <h3 id="secao-5-4">4.4. Método utilizado</h3>
    ...
    <h3 id="secao-5-5">4.5. Taxa de sucesso e falhas</h3>
    ...
    <h3 id="secao-5-6">4.6. Tipos de consulta</h3>
    ...
    <h3 id="secao-5-7">4.7. Consultas por usuário</h3>
