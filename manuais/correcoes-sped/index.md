...
<div class="secao" id="secao-acesso">
  ...
  <div class="secao-conteudo editable-area">
    ...
    <p>Ao entrar no ambiente Digital Dev, o sistema carregará o <strong>Hub de Ferramentas</strong>. Identifique o cartão correspondente e clique no botão <strong>"Acessar Ferramenta"</strong> no módulo de Correções no SPED.</p>
    <div class="img-container">
        <div class="img-wrapper">
...
<div class="secao" id="secao-3">
  ...
  <div class="secao-conteudo editable-area">
    ...
    <div class="img-container">
        <div class="img-wrapper">
            <img src="imagens/1-filtro-contribuinte.png" class="img-screenshot" alt="Filtro de Contribuinte">
        </div>
    ...
    <div class="img-container">
        <div class="img-wrapper">
            <img src="imagens/2-filtro-periodo.png" class="img-screenshot" alt="Filtro de Período">
        </div>
        <p class="img-caption">Definição de Datas Início e Fim</p>
    </div>
    <div class="img-container">
        <div class="img-wrapper">
            <img src="imagens/3-filtro-ncm.png" class="img-screenshot" alt="Filtro de NCM">
        </div>
    ...
    <div class="img-container">
        <div class="img-wrapper">
            <img src="imagens/4-aba-f100-outros.png" class="img-screenshot" alt="Aviso de filtros da Aba F100">
        </div>
        <p class="img-caption">Mensagem solicitando filtros específicos para a aba F100</p>
    </div>
    <div class="img-container">
        <div class="img-wrapper">
            <img src="imagens/5-codigos-conta.png" class="img-screenshot" alt="Preenchimento do Código de Conta">
        </div>
        <p class="img-caption">Preenchendo a Natureza de Base de Crédito no menu suspenso múltiplo</p>
    </div>
    ...
    <div class="img-container">
        <div class="img-wrapper">
            <img src="imagens/7-limpar-produtos.png" class="img-screenshot" alt="Limpar produtos">
        </div>
...
<div class="secao" id="secao-4">
  ...
  <div class="secao-conteudo editable-area">
    ...
    <ul>
        ...
        <div class="img-container">
            <div class="img-wrapper">
                <img src="imagens/8-aba-a170-nfse.png" class="img-screenshot" alt="Aba A170">
            </div>
        ...
        <div class="img-container">
            <div class="img-wrapper">
                <img src="imagens/9-aba-d100-cte.png" class="img-screenshot" alt="Aba D100">
            </div>
        ...
        <div class="img-container">
            <div class="img-wrapper">
                <img src="imagens/10-aba-f100-carregada.png" class="img-screenshot" alt="Aba F100 Carregada">
            </div>
        ...
        <div class="img-container">
            <div class="img-wrapper">
                <img src="imagens/11-aba-120-depreciacao.png" class="img-screenshot" alt="Aba F120">
            </div>
        ...
        <div class="img-container">
            <div class="img-wrapper">
                <img src="imagens/12-aba-130-aquisicao.png" class="img-screenshot" alt="Aba F130">
            </div>
...
<div class="secao" id="secao-5">
  ...
  <div class="secao-conteudo editable-area">
    ...
    <div class="img-container">
        <div class="img-wrapper">
            <img src="imagens/13-como-acessar-tooltip.png" class="img-screenshot" alt="Como acessar Tooltips">
        </div>
    ...
    <div class="img-container">
        <div class="img-wrapper">
            <img src="imagens/14-filtro-colunas.png" class="img-screenshot" alt="Filtro de Colunas">
        </div>
        <p class="img-caption">Filtro suspenso nas colunas de dados</p>
    </div>
    ...
    Se o item no SPED foi agrupado, exibirá o selo <strong>Consolidado</strong>. Ao clicar nesta coluna, uma janela abrirá detalhando todos os itens originários da NFe.</p>
    <div class="img-container">
        <div class="img-wrapper">
            <img src="imagens/15-filtro-detalhes-itens-nfe-consolidado.png" class="img-screenshot" alt="Detalhes de NFe Consolidado">
        </div>
        <p class="img-caption">Janela detalhando a NFe e seus itens originais cruzados com a EFD</p>
    </div>
    <p>Para voltar, basta clicar no <code>X</code> ou fora da janela.</p>
    <div class="img-container">
        <div class="img-wrapper">
            <img src="imagens/16-voltando-a-tabela-principal.png" class="img-screenshot" alt="Retornando à tabela">
        </div>
...
<div class="secao" id="secao-6">
  ...
  <div class="secao-conteudo editable-area">
    ...
    <div class="img-container">
        <div class="img-wrapper">
            <img src="imagens/17-regras-ncm.png" class="img-screenshot" alt="Regras de NCM">
        </div>
        <p class="img-caption">Regras tributárias associadas ao NCM clicado</p>
    </div>
    <div class="img-container">
        <div class="img-wrapper">
            <img src="imagens/18-detalhes-regra.png" class="img-screenshot" alt="Detalhes da Regra">
        </div>
        <p class="img-caption">Expandindo o cartão para visualizar a base legal</p>
    </div>
    ...
    <div class="img-container">
        <div class="img-wrapper">
            <img src="imagens/19-editar-regra.png" class="img-screenshot" alt="Editar Regra">
        </div>
        <p class="img-caption">Janela para edição do mapa tributário</p>
    </div>
    <div class="img-container">
        <div class="img-wrapper">
            <img src="imagens/20-nova-regra.png" class="img-screenshot" alt="Nova Regra">
        </div>
        <p class="img-caption">Formulário de cadastro de nova regra</p>
    </div>
    <p>As modificações feitas aqui serão refletidas instantaneamente. Para voltar, feche a janela.</p>
    <div class="img-container">
        <div class="img-wrapper">
            <img src="imagens/21-voltar-tela-regras.png" class="img-screenshot" alt="Voltando da tela de Regras">
        </div>
...
<div class="secao" id="secao-7">
  ...
  <div class="secao-conteudo editable-area">
    ...
    <div class="img-container">
        <div class="img-wrapper">
            <img src="imagens/22-habilitar-edicao.png" class="img-screenshot" alt="Habilitar Modo Edição">
        </div>
        <p class="img-caption">Botão para entrar no modo de correção em massa</p>
    </div>

    <h3 id="secao-7-2">7.2. Editando registros</h3>
    <p>Você pode alterar os valores digitando diretamente nos campos de texto ou utilizando os menus suspensos (como os códigos da Tabela 4.3.7 em F120/F130). As linhas modificadas ou selecionadas ficarão destacadas em verde.</p>
    <div class="img-container">
        <div class="img-wrapper">
            <img src="imagens/23-editar-registros.png" class="img-screenshot" alt="Editando os registros">
        </div>
    ...
    <div class="img-container">
        <div class="img-wrapper">
            <img src="imagens/24-salvar-alteracoes-aplicacao.png" class="img-screenshot" alt="Salvar Alterações">
        </div>
...
<div class="secao" id="secao-8">
  ...
  <div class="secao-conteudo editable-area">
    ...
    <div class="img-container">
        <div class="img-wrapper">
            <img src="imagens/25-consultar-simples-nacional.png" class="img-screenshot" alt="Consultar Simples Nacional">
        </div>
    ...
    <div class="img-container">
        <div class="img-wrapper">
            <img src="imagens/26-aguardar-consulta-simples-nacional.png" class="img-screenshot" alt="Aguardando a Consulta">
        </div>
    ...
    <div class="img-container">
        <div class="img-wrapper">
            <img src="imagens/27-consulta-finalizada.png" class="img-screenshot" alt="Consulta Finalizada">
        </div>
...
<div class="secao" id="secao-9">
  ...
  <div class="secao-conteudo editable-area">
    ...
    <div class="img-container">
        <div class="img-wrapper">
            <img src="imagens/28-enviar-correcoes-banco.png" class="img-screenshot" alt="Enviar Correções ao Banco">
        </div>
        <p class="img-caption">Submissão definitiva das correções efetuadas</p>
    </div>
    <div class="img-container">
        <div class="img-wrapper">
            <img src="imagens/29-acompanhar-envio-correcoes.png" class="img-screenshot" alt="Acompanhando o envio">
        </div>
    ...
    <div class="img-container">
        <div class="img-wrapper">
            <img src="imagens/30-confirmar-envio-correcoes.png" class="img-screenshot" alt="Confirmação do envio">
        </div>
