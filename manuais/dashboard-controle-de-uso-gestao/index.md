...
<div class="secao" id="secao-1">
  ...
  <div class="secao-conteudo editable-area">
    <p>O dashboard de controle de uso tem como objetivo apresentar aos gestores o volume de consultas realizadas na plataforma e o fluxo de upload de arquivos para o Drive da PSA. O documento é dividido em abas que detalham o comportamento de uso da equipe e a volumetria de dados acessados.</p>
  </div>
</div>
