...
<div class="secao" id="secao-2">
  ...
  <div class="secao-conteudo editable-area">
    <h3 id="secao-2-1">2.1. Acesso ao portal e área da equipe</h3>
    ...
    <h3 id="secao-2-2">2.2. Seleção da área de atuação</h3>
    ...
    <h3 id="secao-2-3">2.3. Login no sistema</h3>
    ...
    <h3 id="secao-2-4">2.4. Seleção do ambiente de trabalho</h3>
    ...
    <h3 id="secao-2-5">2.5. Hub de Ferramentas</h3>
...
<!-- SEÇÃO 3: CONFIGURAÇÃO DA CLASSIFICAÇÃO -->
<div class="secao" id="secao-3">
  ...
  <div class="secao-conteudo editable-area">
    <h3 id="secao-3-1">3.1. Acesso ao Módulo DIFAL</h3>
    ...
    <h3 id="secao-3-3">3.3. Listagem de Contribuintes</h3>
    ...
    <h3 id="secao-3-4">3.4. Seleção do Contribuinte (Razão Social)</h3>
    ...
    <h3 id="secao-3-5">3.5. Definição de Início do Período</h3>
    ...
    <h3 id="secao-3-6">3.6. Definição de Fim do Período</h3>
    ...
    <h3 id="secao-3-7">3.7. Execução da Busca</h3>
...
<!-- SEÇÃO 4: ANÁLISE E CLASSIFICAÇÃO -->
<div class="secao" id="secao-4">
  ...
  <div class="secao-conteudo editable-area">
    <h3 id="secao-4-1">4.1. Painel de Métricas</h3>
    ...
    <h3 id="secao-4-2">4.2. Grade de Itens</h3>
    ...
    <h3 id="secao-4-3">4.3. Identificação de Pendências</h3>
    ...
    <h3 id="secao-4-4">4.4. Modal de Detalhes do Produto</h3>
    ...
    <h3 id="secao-4-5">4.5. Seleção de Regra Tributária</h3>
    ...
    <h3 id="secao-4-6">4.6. Confirmação da Decisão</h3>
...
<!-- SEÇÃO 5: CONFERÊNCIA E EXEMPLOS PRÁTICOS -->
<div class="secao" id="secao-5">
  ...
  <div class="secao-conteudo editable-area">
    <h3 id="secao-5-1">5.1. Atualização de Status</h3>
    ...
    <h3 id="secao-5-2">5.2. Acompanhamento na Lista Geral</h3>
    ...
    <h3 id="secao-5-3">5.3. Exemplos de Status: Pendente e Validado</h3>
    <ul>
    ...
    <h3 id="secao-5-4">5.4. Consolidação da Lista</h3>
...
<!-- SEÇÃO 6: SINCRONIZAÇÃO DE DADOS -->
<div class="secao" id="secao-6">
  ...
  <div class="secao-conteudo editable-area">
    <h3 id="secao-6-1">6.1. Alerta de Sincronização Pendente</h3>
    ...
    <div class="aviso">
        ...
        <p><strong>Atenção:</strong> Caso feche o navegador ou a página durante a classificação, o sistema irá salvar e restaurar a sessão no próximo acesso.</p>
    </div>

    <h3 id="secao-6-2">6.2. Confirmação de Salvamento</h3>
...
<!-- SEÇÃO 7: EXPORTAÇÃO E FINALIZAÇÃO -->
<div class="secao" id="secao-7">
  ...
  <div class="secao-conteudo editable-area">
    <h3 id="secao-7-1">7.1. Solicitação de Exportação</h3>
    ...
    <h3 id="secao-7-2">7.2. Processamento do Arquivo</h3>
    ...
    <h3 id="secao-7-3">7.3. Conclusão do Download</h3>
    ...
    <h3 id="secao-7-4">7.4. Conferência Final</h3>
    ...
    <h3 id="secao-7-5">7.5. Nova Busca e Encerramento</h3>
